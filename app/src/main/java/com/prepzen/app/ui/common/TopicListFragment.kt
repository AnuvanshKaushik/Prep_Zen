...
class TopicListFragment : Fragment(R.layout.fragment_topic_list) {
    ...
    private val categoryId: String by lazy {
        requireArguments().getString("categoryId").orEmpty()
    }

    private val categoryTitle: String by lazy {
        requireArguments().getString("categoryTitle").orEmpty()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.sectionTitle.text = categoryTitle
        ...
        viewModel.topics.observe(viewLifecycleOwner) { topics ->
            ...
            binding.emptyState.visibility = if (topics.isEmpty()) View.VISIBLE else View.GONE
        }
